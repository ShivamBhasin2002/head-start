...
export function POICard({ poi, onSelect, isLight }: POICardProps) {
  const { tgid } = poi;
  const discountPercentage = 5;
  const price = "$40.84";
  return (
    <div
      className={`rounded-2xl p-3 ${isLight ? "bg-[#fff] backdrop-blur-[11px] shadow-[0px_4px_64px_0px_#B45FFF40]" : "bg-[#ffffff10]"}`}
    >
      <div className="flex gap-3 mb-[18px] items-center">
        ...
        <div className="flex-1 flex flex-col justify-between">
          ...
          <div className=" flex gap-1.5 mt-1.5 items-center">
            ...
            />
            <span
              className={`flex items-center gap-1 font-[halyard-text] font-light text-[12px] leading-[20px] tracking-[0] ${isLight ? "text-[#AF2525E5]" : "text-[#F79696E5]"} pressable`}
            >
              <svg
                width="12"
                height="12"
